...
public class ExcelExportUtil {
    ...
    private void createHeaderRow() {
        ...
        // Заголовок
        Row row = sheet.createRow(0); // row = 0 title
        ...
        sheet.addMergedRegion(new CellRangeAddress(0, 0, 0, 8)); // количество столбцов Customer и Address
        font.setFontHeightInPoints((short) 10);

        // Шапка таблицы
        row = sheet.createRow(1); // row = 1 header
        font.setBold(true);
